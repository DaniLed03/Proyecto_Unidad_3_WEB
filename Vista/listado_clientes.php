                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>" . $row['edad'] . "</td>";
                            echo "<td>";
                            echo "<button onclick='confirmarEdicion(" . $row['id_cliente'] . ")' class='btn btn-primary'>Editar</button>";
                            //echo "<button onclick='confirmarEliminacion(" . $row['id_cliente'] . ")' class='btn btn-danger'>Eliminar</button>";                        echo "</td>";
                            echo "</tr>";
                        }
                    } else {
        ...
        function confirmarEliminacion(id_cliente) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "../Controladores/clienteController.php?action=eliminar&id=" + id_cliente;
                }
            });
        }
        ...
        function confirmarEdicion(id_cliente) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "../Vista/editar_cliente.php?id=" + id_cliente;
                }
            });
        }
    </script>
