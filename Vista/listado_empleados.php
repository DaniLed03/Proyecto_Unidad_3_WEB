...
<nav class="navbar navbar-expand-lg navbar-custom">
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>" . $row['edad'] . "</td>";
                            echo "<td>";
                            echo "<button onclick='confirmarEdicion(" . $row['id_empleado'] . ")' class='btn btn-primary'>Editar</button>";
                            //echo "<button onclick='confirmarEliminacion(" . $row['id_empleado'] . ")' class='btn btn-danger'>Eliminar</button>";                        echo "</td>";
                            echo "</tr>";
                        }
                    } else {
    ...
    <script>
        ...
        function confirmarEliminacion(id_empleado) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "../Controladores/empleadoController.php?action=eliminar&id=" + id_empleado;
                }
            });
        }
        ...
        function confirmarEdicion(id_empleado) {
            Swal.fire({
                title: "¿Quieres editar este empleado?",
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "../Vista/editar_empleado.php?id=" + id_empleado;
                }
            });
        }
    </script>
