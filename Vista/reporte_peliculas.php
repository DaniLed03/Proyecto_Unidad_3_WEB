...
<nav class="navbar navbar-expand-lg navbar-custom">
    ...
    <div class="container mt-5">
        <div class="container-form" style="background-color: #001834; padding: 20px;">
            <h2 class="mb-4" id="modificar" name="modificar">Peliculas Vendidas En Rango de Fechas</h2>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    {  
                          ...
                          echo("<script> document.getElementById('modificar').textContent = 'Los 5 Peliculas Mas Vendidas En El Periodo: $fechaInicio - $fechaFin'; </script>");
                          echo("<P style='text-align:right;'> Fecha Inicio: $fechaInicio");
                          echo("  Fecha Fin: $fechaFin </p>");
                          $query = "SELECT id_pelicula, SUM(cantidad) as cantidad, SUM(total) as total FROM ticket_pelicula WHERE fecha BETWEEN '$fechaInicio' AND '$fechaFin' GROUP BY id_pelicula";
                    }
                  else
                    {
            ...
            <a href="reporte_cliente.php" class="btn btn-primary">Clientes Que Ven Mas Peliculas</a>
        </div>
    </div>
