                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>";
                            echo "<button onclick='confirmarEdicion(" . $row['id_producto'] . ")' class='btn btn-primary'>Editar</button>";
                            //echo "<button onclick='confirmarEliminacion(" . $row['id_producto'] . ")' class='btn btn-danger'>Eliminar</button>";                        echo "</td>";
                            echo "</tr>";
                        }
                    } else {
        ...
        function confirmarEliminacion(id_producto) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "../Controladores/productoController.php?action=eliminar&id=" + id_producto;
                }
            });
        }
        // Función para mostrar la alerta de edición
        function confirmarEdicion(id_producto) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "../Vista/editar_producto.php?id=" + id_producto;
                }
            });
        }
    </script>
