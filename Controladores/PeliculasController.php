...
class PeliculasController {
    public function altaPelicula() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($pelicula->agregarPelicula($nombre, $sinopsis, $id_genero, $fecha_inicio_cartelera, $fecha_fin_cartelera, $boletos)) {
    ...
    public function editarPelicula() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($pelicula->editarPelicula($id, $nombre, $sinopsis, $id_genero, $fecha_inicio_cartelera, $fecha_fin_cartelera, $boletos)) {
                header('Location: ../Vista/listado_peliculas.php');
                exit;
            } else {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_GET['action']) && $_GET['action'] === 'editar' && !isset($_SESSION['formulario_enviado'])) {
    ...
    $peliculasController = new PeliculasController();
    $peliculasController->editarPelicula($id, $nombre, $sinopsis, $id_genero, $fecha_inicio_cartelera, $fecha_fin_cartelera, $boletos);
}
/*
